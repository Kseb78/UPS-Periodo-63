...
public class VentanaEliminarLibro extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnEliminarLibro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/eliminarIcon.png"))); // NOI18N
    ...
    private void btnEliminarLibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarLibroActionPerformed
        ...
        if (libro!=null)
        {
            ...
            int i = JOptionPane.showConfirmDialog(null, "¿Esta seguro de eliminar el Libro?");
            if (i==0)
            {
            ...
            {
                JOptionPane.showMessageDialog(this,"No se ha eliminado el Libro");
            }
    ...
    public void cambiarIdioma(Locale locale)
    {
        ...
        btnEliminarLibro.setText(mensajes.getString("btnEliminarLibro"));   
        btnLimpiarLibro.setText(mensajes.getString("btnLimpiarLibro"));
        this.setTitle(mensajes.getString("eliminarLibroMenuItem1"));
    }

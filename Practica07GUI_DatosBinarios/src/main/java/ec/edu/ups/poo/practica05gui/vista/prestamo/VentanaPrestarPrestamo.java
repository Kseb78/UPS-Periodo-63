...
public class VentanaPrestarPrestamo extends javax.swing.JInternalFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(47, 47, 47)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(datoFechaDevolucion, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
    ...
    private void btnPrestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrestarActionPerformed
        ...
        {
            Biblioteca biblioteca = prestamoControlador.readBiblioteca(Integer.parseInt(comboBibliotecas.getSelectedItem().toString()));
            biblioteca.getListaLibros();
            
            String titulo = comboLibros.getSelectedItem().toString();
            int identificacion = Integer.parseInt(comboUsuarios.getSelectedItem().toString());        
            ...
            if(fechaPrestamo.getTime()<fechaDevolucion.getTime())
            {
            ...
            {
                JOptionPane.showMessageDialog(this, "La fecha de devolucion no puede ser mayor a la del prestamo");  
            }
        }

...
public class VentanaListarBiblioteca extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel modelo = (DefaultTableModel) tablaDatosBiblioteca.getModel();
    modelo.setNumRows(0);
    ...
    public void cambiarIdioma(Locale locale)
    {
        ...
        String nombre = (mensajes.getString("nombreBiblioteca"));
        String direccion = (mensajes.getString("direccionBiblioteca"));
        String telefono = (mensajes.getString("telefonoBiblioteca"));
        
        DefaultTableModel tabla = (DefaultTableModel) tablaDatosBiblioteca.getModel();
        tabla.setColumnIdentifiers(new String [] {codigo, nombre, direccion, telefono});
        this.setTitle(mensajes.getString("listarBibliotecaMenuItem"));
